...
### Admin Panel URL
👉 **https://windelsgreen-decoresin.com/admin_new/**

### Demo Pagina
👉 **https://windelsgreen-decoresin.com/admin_new/demo.html**

### Oude Admin (ter vergelijking)
...
```javascript
await fetchWithCSRF('/admin_new/functions/products/save.php', {
    method: 'POST',
    body: formData
});
```
...
**BELANGRIJK**: De oude admin blijft volledig werken op `/admin/`. Je kunt beide systemen naast elkaar gebruiken tijdens de transitie.
