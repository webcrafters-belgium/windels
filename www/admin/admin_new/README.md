...
```bash
mysql -h mgielen.zapto.org -P 3306 -u matthias -p'DigiuSeppe2018___' windelsgreendecoresincom-db < /app/admin_new/migration.sql
```
...
$sql = file_get_contents('/app/admin_new/migration.sql');
...
Navigeer naar: **https://windelsgreen-decoresin.com/admin_new/**
