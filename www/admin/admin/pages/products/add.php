...
<div class="card-glass p-6 mb-6 border-amber-500/50 bg-amber-500/10" data-testid="db-warning">
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-sm" style="color: var(--text-muted);">De database verbinding is niet actief. Producten kunnen niet worden opgeslagen tot de database verbinding is hersteld.</p>
        </div>
    </div>
</div>
<?php endif; ?>
...
<form id="productForm" action="/admin/functions/products/save.php" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <select name="category_id" id="category" required 
                    ...
                    <?php else: ?>
                        ...
                        <option value="2">Kaarsen</option>
                        <option value="3">Terrazzo</option>
                        <option value="4">Epoxy</option>
                    <?php endif; ?>
                </select>
            </div>
    ...
    <div class="flex items-center justify-between gap-4">
        <a href="/admin/pages/products/index.php" 
