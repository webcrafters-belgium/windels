...
<div class="card-glass p-6 mb-6 border-amber-500/50 bg-amber-500/10" data-testid="db-warning">
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-sm" style="color: var(--text-muted);">De database verbinding is niet actief. Productgegevens kunnen niet worden geladen.</p>
        </div>
    </div>
</div>
<?php endif; ?>
...
<div class="mb-8">
    <div class="flex items-center justify-between">
        ...
        <a href="/admin/pages/products/add.php" class="accent-bg text-white px-8 py-4 rounded-lg font-bold text-lg hover:opacity-90 transition flex items-center">
...
<div class="card-glass p-6 mb-8">
    <form method="get" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="md:col-span-2 lg:col-span-4 flex gap-4">
            ...
            <a href="/admin/pages/products/index.php" class="glass px-6 py-2 rounded-lg font-semibold hover:opacity-90 transition">
                        ...
                        <tr class="border-b hover:bg-opacity-50 transition" style="border-color: var(--border-glass);">
                            ...
                            <td class="py-4 px-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="/admin/pages/products/edit.php?id=<?= $p['id'] ?>" 
...
async function deleteProduct(id) {
    ...
    try {
        const response = await fetchWithCSRF('/admin/functions/products/delete.php', {
            method: 'POST',
