...
$currentCouponPercent = (float)($_SESSION['applied_coupon']['discount'] ?? 0);
        ...
        <?php else: ?>
            <div class="row g-4 flex-column flex-md-row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form id="couponForm" method="post" action="/functions/shop/cart/apply_coupon.php"
                    ...
                    <div id="coupon_feedback">
                        ...
                        <span>
                            ...
                            toegepast (<?= (int)$currentCouponPercent ?>%)
                        </span>
                ...
                <div class="col-12 col-md-6">
                    <div class="mb-4 text-center">
                        ...
                        <p id="coupon_line" class="text-danger" style="display: <?= $currentCouponPercent ? 'block' : 'none' ?>;">
                            Korting: -<?= (int)$currentCouponPercent ?>%
                        </p>
                        <p id="total_price" class="fs-4 fw-semibold text-success"
                           data-base-subtotal="<?= number_format($baseTotal, 2, '.', '') ?>"
                           data-current-coupon-percent="<?= $currentCouponPercent ?>">
                            €<?= number_format($baseTotal * (1 - $currentCouponPercent/100), 2, ',', '.') ?>
                        </p>
                    </div>
